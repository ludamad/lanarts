...
generate = (portal_spawns, monster_spawns) ->
    Arena.monster_spawns = monster_spawns
    map = NewMaps.try_n_times MAX_MAP_TRIES, () -> Arena\compile(portal_spawns)
