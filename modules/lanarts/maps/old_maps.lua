...
--          items =    { amount = 7,  group = Enchanted Items   }
--          enemies = {
--            amount = {12,15}
--            generated = {
...
--          items =    { amount = 8,  group = Enchanted Items   }
--          enemies = {
--            amount = {12,15}
--            generated = {
...
--        content = {
--          features = { tileset = all_tilesets}
--          items =    { amount = 10,  group = Enchanted Items   }
--          enemies =   
--            amount = 22       
...
--        content = {
--          features = { tileset = all_tilesets}
--          items =    { amount = 12,  group = Enchanted Items   }
--          enemies =   
--            amount = 25       
...
--          items =    { amount = 14,  group = Enchanted Items   }
--          enemies = {
--            amount = 30 
--            generated = {
...
local function generate_items(map, items, tileset)
    for i=1,range_resolve(items.amount) do
        local item = item_utils.item_generate(items.group)
...
local function generate_from_enemy_entries(map, chances, amount)
    ...
    for entry in values(chances) do
        ...
        local spawns = entry.guaranteed_spawns or 0
        for i=1,spawns do 
...
local function generate_content(map, content, tileset)
    generate_items(map, content.items, tileset)
