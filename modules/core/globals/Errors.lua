...
local LUAFILE_PATTERN = "modules/[^%.]*%.lua"
...
M = {
    filter_patterns = {
        ...
        ["%s*modules/core/globals/Errors%.lua.* in function <modules"] = 1,
        ["%s*modules/core/globals/Modules%.lua.* in function 'import'"] = 2,
        ["%s*modules/core/Main.lua"] = 1,
