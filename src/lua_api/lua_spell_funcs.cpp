...
//// Take arguments: caster, target; returns x, y
//static int spell_mephitize(LuaStackValue target) {
//    GameState* gs = lua_api::gamestate(L);
//    CombatGameInst* inst = luawrap::get<CombatGameInst*>(L, 1);
//
//}
