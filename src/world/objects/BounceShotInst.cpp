...
BounceShotInst::BounceShotInst(obj_id originator, Attack& attack, int x, int y, int tx, int ty) :
...
void BounceShotInst::step(GameState* gs) {
    Pos tile_hit;
...
void BounceShotInst::draw(GameState* gs) {
