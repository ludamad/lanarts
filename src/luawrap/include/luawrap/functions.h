...
namespace luawrap {
	namespace _private {
		...
		struct FuncWrap<void (*)(A1)> {
		    static int cppfunction(lua_State* L) {
		        if (!argcheck(L, lua_tostring(L, lua_upvalueindex(2)), 1, check<A1>(L, 1))) { return 0; }
		...
		struct FuncWrap<void (*)(A1,A2)> {
		    static int cppfunction(lua_State* L) {
		        if (!argcheck(L, lua_tostring(L, lua_upvalueindex(2)), 1, check<A1>(L, 1))||!argcheck(L, lua_tostring(L, lua_upvalueindex(2)), 2, check<A2>(L, 2))) { return 0; }
		...
		struct FuncWrap<void (*)(A1,A2,A3)> {
		    static int cppfunction(lua_State* L) {
		        if (!argcheck(L, lua_tostring(L, lua_upvalueindex(2)), 1, check<A1>(L, 1))||!argcheck(L, lua_tostring(L, lua_upvalueindex(2)), 2, check<A2>(L, 2))||!argcheck(L, lua_tostring(L, lua_upvalueindex(2)), 3, check<A3>(L, 3))) { return 0; }
		...
		struct FuncWrap<void (*)(A1,A2,A3,A4)> {
		    static int cppfunction(lua_State* L) {
		        if (!argcheck(L, lua_tostring(L, lua_upvalueindex(2)), 1, check<A1>(L, 1))||!argcheck(L, lua_tostring(L, lua_upvalueindex(2)), 2, check<A2>(L, 2))||!argcheck(L, lua_tostring(L, lua_upvalueindex(2)), 3, check<A3>(L, 3))||!argcheck(L, lua_tostring(L, lua_upvalueindex(2)), 4, check<A4>(L, 4))) { return 0; }
