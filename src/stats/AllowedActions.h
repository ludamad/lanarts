...
struct AllowedActions {
	bool can_use_rest, can_use_stairs, can_use_items, can_use_spells, can_use_weapon;
	AllowedActions() :
			can_use_rest(true), can_use_stairs(true), can_use_items(true), can_use_spells(
					true), can_use_weapon(true) {
	}
	AllowedActions only_in_both(const AllowedActions& aa) const {
		...
		ret.can_use_weapons = aa.ccan_use_weapons && this->can_use_weapons;
		return ret;
	}
};
