...
void load_equipment_data(lua_State* L, const FilenameList& filenames,
	...
	luawrap::dofile(L, "game/lanarts/items/armour/BodyArmour.lua");
	luawrap::dofile(L, "game/lanarts/items/armour/Boots.lua");
	luawrap::dofile(L, "game/lanarts/items/armour/Gloves.lua");
	luawrap::dofile(L, "game/lanarts/items/armour/Helmets.lua");
	luawrap::dofile(L, "game/lanarts/items/rings/Rings.lua");
}
